...
public class QLearpackage com.technobium.rl;
...
public class QLearning {
    ...
    public void init() {
        File file = new File("C:/Users/kclic/q-learning-java-master/resources/maze.txt");
    ...
    double maxQ(int nextState) {
        ...
        //Q value will remain over -10 after the lowest reward(-10) is inputted into the Q function
        double maxValue = -10;
        ...
        System.out.println("Max value of next action for " + nextState + ": "  + maxValue);
        return maxValue;
    }
    ...
    void calculateQ() {
        ...
        for (int i = 0; i < 1000; i++) { // Train cycles
            ...
            while (!isFinalState(crtState)) {
                ...
                // Q(state,action)= Q(state,action) + alpha package com.technobium.rl;
...
* (R(state,action) + gamma * Max(next state, all actions) - Q(state,action))
                double q = Q[crtState][nextState];
                double maxQ = maxQ(nextState);
                int r = R[crtState][nextState];
